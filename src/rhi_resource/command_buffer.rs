...
use crate::rhi::{queue::RhiQueue, Rhi};
...
impl RhiCommandBuffer
{
        ...
        F: FnOnce(vk::CommandBuffer),
    {
        unsafe {
            ...
            let fence = rhi.create_fence(false, Some("one-time-command-fence"));
            ...
            //       是否需要动态决定呢？可以静态决定吗？
            command_buffer.submit_command(rhi.graphics_queue(), &[], &[], &[], Some(fence));
