...
impl FrameBuffers {
    ...
    fn register_bindless(&self, bindless_mgr: &mut BindlessManager) {
        ...
        bindless_mgr.register_image_shared(self.depth_image_view.clone());
    ...
    fn unregister_bindless(&self, bindless_mgr: &mut BindlessManager) {
        ...
        bindless_mgr.unregister_image(&self.depth_image_view.uuid());

        for key in &self.render_target_bindless_keys {
...
// getter
impl FrameBuffers {
    pub fn render_target(&self, frame_label: FrameLabel) -> (&RhiTexture2D, String) {
        (
    ...
    pub fn render_target_bindless_handle(
        &self,
