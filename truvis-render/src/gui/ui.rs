...
pub struct Gui {
    ...
    _fonts_texture_id: imgui::TextureId,
...
impl Gui {
    pub fn new(
        ...
        let fonts_texture_id = Self::init_fonts(rhi, &mut imgui_ctx, &platform, &mut bindless_mgr.borrow_mut());

        Self {
            imgui_ctx,
            platform,

            _fonts_texture_id: fonts_texture_id,
...
impl Gui {
    ...
    pub fn imgui_render(&mut self, rhi: &Rhi, render_ctx: &mut FrameContext) -> Option<(&GuiMesh, &imgui::DrawData)> {
