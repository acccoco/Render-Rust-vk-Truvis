...
PsOutput main(PsInput input)
{
    ...
    const float3 view_dir = normalize(input.world_pos - camera_pos);
    ...
    const float3 diffuse_color = diffuse_texture.Sample(diffuse_sampler, input.uv).rgb * diffuse_coef * light_color;
