...
impl IndexBuffer {
    ...
    #[inline]
    pub fn new_with_data(rhi: &RenderContext, data: &[u32], debug_name: impl AsRef<str>) -> Self {
        let mut index_buffer = Self::new(rhi.device_functions(), rhi.allocator.clone(), data.len(), debug_name);
