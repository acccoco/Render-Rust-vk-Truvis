...
impl RhiCommandBuffer {
    pub fn new(
        ...
        let command_buffer = unsafe { device_pf.vk_device_pf.allocate_command_buffers(&info).unwrap()[0] };
    ...
    pub fn free(self) {
        unsafe {
            self.device_pf.free_command_buffers(self.command_pool_handle, std::slice::from_ref(&self.vk_handle));
        }
    }
}
...
impl RhiCommandBuffer {
    ...
    {
        let command_buffer =
            RhiCommandBuffer::new(device, debug_utils, command_pool, &format!("one-time-{}", name.as_ref()));

        command_buffer.begin(vk::CommandBufferUsageFlags::ONE_TIME_SUBMIT, name.as_ref());
        let result = func(&command_buffer);
        command_buffer.end();

        queue.submit(vec![RhiSubmitInfo::new(&[command_buffer])], None);
        queue.wait_idle();
        command_buffer.free();
    ...
    pub fn end(&self) {
        self.end_label();
        unsafe { self.device_pf.end_command_buffer(self.vk_handle).unwrap() }
    }
}
...
impl RhiCommandBuffer {
    ...
    pub fn cmd_copy_buffer_1(&self, src: &RhiBuffer, dst: &mut RhiBuffer, regions: &[vk::BufferCopy]) {
        unsafe {
            self.device_pf.cmd_copy_buffer(self.vk_handle, src.handle(), dst.handle(), regions);
        }
    }
    ...
    pub fn cmd_copy_buffer_to_image(&self, copy_info: &vk::CopyBufferToImageInfo2) {
        unsafe { self.device_pf.cmd_copy_buffer_to_image2(self.vk_handle, copy_info) }
    }
    ...
    pub fn cmd_update_buffer(&self, buffer: vk::Buffer, offset: vk::DeviceSize, data: &[u8]) {
        unsafe { self.device_pf.cmd_update_buffer(self.vk_handle, buffer, offset, data) }
    }
    ...
    pub fn cmd_push_constants(
        ...
        unsafe {
            self.device_pf.cmd_push_constants(self.vk_handle, pipeline_layout, stage, offset, data);
        }
    }
}
...
impl RhiCommandBuffer {
    ...
    pub fn cmd_begin_rendering(&self, render_info: &vk::RenderingInfo) {
        unsafe {
            self.device_pf.dynamic_rendering_pf().cmd_begin_rendering(self.vk_handle, render_info);
        }
    }
    ...
    pub fn cmd_begin_rendering2(&self, rendering_info: &RhiRenderingInfo) {
        ...
        unsafe {
            self.device_pf.dynamic_rendering_pf().cmd_begin_rendering(self.vk_handle, &rendering_info);
        }
    }
    ...
    pub fn end_rendering(&self) {
        unsafe {
            self.device_pf.dynamic_rendering_pf().cmd_end_rendering(self.vk_handle);
        }
    }
    ...
    pub fn draw_indexed(
        ...
        unsafe {
            self.device_pf.cmd_draw_indexed(
                self.vk_handle,
                index_cnt,
                instance_cnt,
                first_index,
    ...
    pub fn cmd_draw(&self, vertex_count: u32, instance_count: u32, first_vertex: u32, first_instance: u32) {
        unsafe {
            self.device_pf.cmd_draw(self.vk_handle, vertex_count, instance_count, first_vertex, first_instance);
        }
    }
    ...
    pub fn bind_descriptor_sets(
        ...
        unsafe {
            self.device_pf.cmd_bind_descriptor_sets(
                self.vk_handle,
                bind_point,
                pipeline_layout,
                first_set,
    ...
    pub fn cmd_bind_pipeline(&self, bind_point: vk::PipelineBindPoint, pipeline: vk::Pipeline) {
        unsafe {
            self.device_pf.cmd_bind_pipeline(self.vk_handle, bind_point, pipeline);
        }
    }
    ...
    pub fn cmd_bind_vertex_buffers(&self, first_bind: u32, buffers: &[RhiBuffer], offsets: &[vk::DeviceSize]) {
        unsafe {
            ...
            self.device_pf.cmd_bind_vertex_buffers(self.vk_handle, first_bind, &buffers, offsets);
        }
    }
    ...
    pub fn cmd_bind_index_buffer(&self, buffer: &RhiBuffer, offset: vk::DeviceSize, index_type: vk::IndexType) {
        unsafe {
            self.device_pf.cmd_bind_index_buffer(self.vk_handle, buffer.handle(), offset, index_type);
        }
    }
    ...
    pub fn cmd_set_viewport(&self, first_viewport: u32, viewports: &[vk::Viewport]) {
        unsafe {
            self.device_pf.cmd_set_viewport(self.vk_handle, first_viewport, viewports);
        }
    }
    ...
    pub fn cmd_set_scissor(&self, first_scissor: u32, scissors: &[vk::Rect2D]) {
        unsafe {
            self.device_pf.cmd_set_scissor(self.vk_handle, first_scissor, scissors);
        }
    }
}
...
impl RhiCommandBuffer {
    ...
    pub fn cmd_copy_acceleration_structure(&self, copy_info: &vk::CopyAccelerationStructureInfoKHR) {
        unsafe {
            self.device_pf.acceleration_structure_pf().cmd_copy_acceleration_structure(self.vk_handle, copy_info);
        }
    }
    ...
    pub fn build_acceleration_structure(
        ...
        unsafe {
            ...
            self.device_pf.acceleration_structure_pf().cmd_build_acceleration_structures(
                self.vk_handle,
    ...
    pub fn write_acceleration_structure_properties(
        ...
        unsafe {
            self.device_pf.acceleration_structure_pf().cmd_write_acceleration_structures_properties(
                self.vk_handle,
    ...
    pub fn trace_rays(
        ...
        unsafe {
            self.device_pf.rt_pipeline_pf().cmd_trace_rays(
                self.vk_handle,
                raygen_table,
                miss_table,
                hit_table,
...
impl RhiCommandBuffer {
    ...
    pub fn cmd_dispatch(&self, group_cnt: glam::UVec3) {
        unsafe {
            self.device_pf.cmd_dispatch(self.vk_handle, group_cnt.x, group_cnt.y, group_cnt.z);
        }
    }
}
...
impl RhiCommandBuffer {
    ...
    pub fn memory_barrier(&self, barriers: &[vk::MemoryBarrier2]) {
        ...
        unsafe {
            self.device_pf.cmd_pipeline_barrier2(self.vk_handle, &dependency_info);
        }
    }
...
impl RhiCommandBuffer {
    ...
    pub fn begin_label(&self, label_name: &str, label_color: glam::Vec4) {
        self.device_pf.debug_utils().cmd_begin_debug_label(self.vk_handle, label_name, label_color);
    }
    ...
    pub fn end_label(&self) {
        self.device_pf.debug_utils().cmd_end_debug_label(self.vk_handle);
    }
    ...
    pub fn insert_label(&self, label_name: &str, label_color: glam::Vec4) {
        self.device_pf.debug_utils().cmd_insert_debug_label(self.vk_handle, label_name, label_color);
    }
}
