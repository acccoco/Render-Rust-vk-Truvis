...
fn main() {
    ...
    let mut mesh_map: HashMap<uuid::Uuid, Mesh> = HashMap::new();
    let mut mat_map: HashMap<uuid::Uuid, Material> = HashMap::new();
    let mut ins_map: HashMap<uuid::Uuid, Instance> = HashMap::new();
